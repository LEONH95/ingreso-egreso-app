...
export class IngresoEgresoService {
  ...
  ingresoEgresoItemsenerSubs: Subscription = new Subscription();
  ...
  cancelarSubcriptions() {
    ...
    this.ingresoEgresoItemsenerSubs.unsubscribe();
  ...
  private ingresoEgresoItems(uid: string) {
    this.ingresoEgresoItemsenerSubs = this.afDB.collection(`${uid}/ingresos-egresos/items`)
      .snapshotChanges()
      .pipe(
        map(docData => {
          return docData.map(doc => {
            return {
              ...
              ...(doc.payload.doc.data() as object)// correcta
            };
          });
        })
      )
